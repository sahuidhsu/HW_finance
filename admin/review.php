...
<div class="container" style="padding-top:70px; margin-bottom: 110px">
    <div class="col-md-10 center-block" style="float: none;">
        <h2 style="text-align: center">支出审核</h2>
        <div class="table-responsive">
            <table class="table table-striped">
                ...
                foreach ($result as $row) {
                    ...
                    echo "<td><a onclick='return out()' href='review.php?action=approve&id=" . $row["id"] . "'><button type=\"button\" class=\"btn btn-primary\">通过</button></a></td>";
                    echo "</tr>";
                }
                ?>
                </tbody>
